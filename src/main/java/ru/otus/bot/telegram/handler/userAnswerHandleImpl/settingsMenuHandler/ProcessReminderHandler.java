...
public class ProcessReminderHandler implements UserAnswerHandler {
    ...
    public SendMessage handleUserAnswer(String usersAnswer, long userId, String chatId) {
        settingMenuFactory.getSettingMenuByState(BotState.PROCESS_REMINDER).processUserAnswer(userId,usersAnswer);
    ...
    public BotState getHandlerName() {
        return BotState.PROCESS_REMINDER;
    }
}
