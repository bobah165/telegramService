...
public class GasHandler implements UserAnswerHandler {
    ...
    public SendMessage handleUserAnswer(String usersAnswer, long userId, String chatId) {
        ...
        costsMenuFactory.getCostsMenuByState(MetricType.GAS).processUserAnswer(userId, usersAnswer);
