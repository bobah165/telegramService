...
public class ProcessScheduledHandler implements UserAnswerHandler {
    ...
    public SendMessage handleUserAnswer(String usersAnswer, long userId, String chatId) {
        settingMenuFactory.getSettingMenuByState(BotState.PROCESS_SCHEDULED).processUserAnswer(userId,usersAnswer);
