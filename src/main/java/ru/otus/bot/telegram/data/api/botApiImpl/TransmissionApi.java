...
public class TransmissionApi implements BotApi {
    private final ButtonBuilder buttonBuilder;
    private final CallBackMenuFactory callBackMenuFactory;

    @Override
    public ReplyKeyboard getApi() {
        return buttonBuilder.addCallBackButtons(callBackMenuFactory.getButtons(CallBackMenu.TRANSMISSION_MENU)
                                                                   .getButtonNames());
    }

    @Override
    public BotApiNames getBotApiName() {
        return BotApiNames.TRANSMISSION_API;
    }
}
