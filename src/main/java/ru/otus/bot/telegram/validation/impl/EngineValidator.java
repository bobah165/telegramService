...
public class EngineValidator implements UserAnswerValidator {
    ...
    public void validateUserAnswer(String usersAnswer, String chatId) {
        ...
        if (!pattern.matcher(usersAnswer).matches()) {
            throw new UserAnswerValidationException(chatId, translator.translateMessage("engine.wrong.format"));
        }
    }
