...
public class TransmissionStateBuilder implements CarMenuStateBuilder {
    ...
    public void processUserAnswer(long userId, String usersAnswer) {
        botStateStorageService.setCurrentBotState(userId, BotState.TRANSMISSION);
        carCacheService.setCarEngine(userId, usersAnswer);
    }
